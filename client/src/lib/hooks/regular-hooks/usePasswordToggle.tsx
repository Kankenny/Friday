...
const usePasswordToggle = () => {
  ...
  const icon = !isVisible ? (
    <svg
      className="dark:text-primary cursor-pointer text-gray-500 opacity-40 duration-200 ease-in-out hover:text-black hover:opacity-100 dark:hover:text-gray-500"
      stroke="currentColor"
      fill="currentColor"
      strokeWidth="0"
