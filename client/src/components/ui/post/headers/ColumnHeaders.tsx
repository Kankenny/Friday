const ColumnHeaders = () => {
  return (
    <div className="flex justify-between text-center font-semibold ">
      <h1 className="flex-grow max-w-[45%] bg-secondary text-tertiary border border-tertiary p-2 rounded-tl-md text-sm">
        Task
      </h1>
      <h1 className="flex-grow max-w-[25%] bg-secondary text-tertiary border border-tertiary p-2 text-sm">
        Progress
      </h1>
